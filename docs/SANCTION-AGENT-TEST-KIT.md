...
**Target API (live):** `https://getsanction.vercel.app/api/v1`

```bash
export SANCTION_API="https://getsanction.vercel.app/api/v1"
```
...
```json
{
  "mcpServers": {
    "sanction": {
      ...
      "args": ["sanction-mcp"],
      "env": {
        "SANCTION_API_URL": "https://getsanction.vercel.app/api/v1",
