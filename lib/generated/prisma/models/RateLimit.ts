...
export type RateLimitWhereInput = {
  ...
  windowEnd?: Prisma.DateTimeFilter<"RateLimit"> | Date | string
}
...
export type RateLimitScalarWhereWithAggregatesInput = {
  ...
  windowEnd?: Prisma.DateTimeWithAggregatesFilter<"RateLimit"> | Date | string
}
...
export type RateLimitOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "count" | "windowEnd", ExtArgs["result"]["rateLimit"]>
...
export interface RateLimitFieldRefs {
  ...
  readonly windowEnd: Prisma.FieldRef<"RateLimit", 'DateTime'>
}
