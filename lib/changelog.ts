...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  {
    date: "2026-07-10",
    title: "Capabilities ask first from any MCP host — sanction-mcp 0.6.0",
