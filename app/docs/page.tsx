...
const deeper = [
  ...
  { title: "MCP 2026-07-28 conformance", desc: "Where sanction-mcp stands against MCP's largest revision — and why its auth hardening isn't the policy layer.", href: "/docs/mcp-2026-07-28" },
