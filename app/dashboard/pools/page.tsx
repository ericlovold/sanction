    ...
    <div className="mx-auto min-h-screen max-w-6xl space-y-6 p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.85fr)]">
        <Card className="border-zinc-800 bg-zinc-900">
          ...
          <CardContent className="px-5 pb-5">
            {pools.rows.length <= 1 && <p className="text-sm text-zinc-600">No pools yet. Create a child wallet (POST /v1/wallets with parent_id) and its budget becomes a pool that rolls up here.</p>}
            <div>
              {pools.rows.map((pool) => (
