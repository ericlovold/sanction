        ...
        <form method="get" className="flex items-end gap-2">
          <label className="block">
            ...
            <input
              ...
              defaultValue={from}
              max={to}
              className="mt-1 block rounded-md border border-border bg-card px-2.5 py-1.5 font-mono text-xs text-foreground outline-none focus:border-border"
            />
          </label>
          <label className="block">
          ...
          {byAgent.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                ...
                <tbody className="font-mono text-muted-foreground tabular-nums">
                  {byAgent.map((a) => (
                  ...
                  {feed.events.map((e) => {
                    ...
                    return (
                      <tr key={`${e.type}-${e.id}`} className="border-t border-border">
                        <td className="py-1.5 pr-3 whitespace-nowrap font-mono text-xs text-muted-foreground tabular-nums">
